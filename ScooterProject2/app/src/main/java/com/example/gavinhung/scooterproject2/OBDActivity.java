...
public class OBDActivity extends AppCompatActivity {
    ...
    //Element
    TextView BTResult;
    Button ReConnectButton,BTRestart;
    ImageView Image_connect, Image_unconnect;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Image_unconnect = (ImageView) findViewById(R.id.image_unconnect);
        ...
        Image_unconnect.setVisibility(View.VISIBLE);
    ...
    private void OpenOBD() throws IOException {
        ...
        beginListenForData();
        Image_unconnect.setVisibility(View.INVISIBLE);
        Image_connect.setVisibility(View.VISIBLE);
